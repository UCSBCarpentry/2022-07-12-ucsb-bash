...
{% else %}
<p><a href="https://ucsb.co1.qualtrics.com/jfe/form/SV_6FEjAgkTgDbk9dI">Pre-workshop Survey</a></p>
<p><a href="https://ucsb.co1.qualtrics.com/jfe/form/SV_1GqnfU22HJZuX54">Post-workshop Survey</a></p>
{% endif %}
...
<p>
  ...
  In addition, you will need an up-to-date web browser.  Please install/update the below video conference application we will be using, <stong>if you are attending this workshop remotely.</strong>
</p>
<p>
